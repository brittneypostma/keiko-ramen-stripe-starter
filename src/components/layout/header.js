...
const badgeStyles = `absolute -mt-12 -mr-2 right-0 bg-white text-orange text-sm text-center border-red border-solid border-2 rounded-full h-6 w-6 leading-5 pl-2px`
      ...
      <div className={headerWrapper}>
        ...
        <div className="w-full flex justify-end items-center">
          ...
          <Link to='/cart' className="relative">
            ...
            <p className={badgeStyles}>{cartCount}</p>
          </Link>
        </div>
      </div>
    </header>
